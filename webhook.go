...
const (
	admissionWebhookAnnotationInjectKey = "sidecar-injector-webhook.doofenshmirtz.me/ignore"
	admissionWebhookAnnotationStatusKey = "sidecar-injector-webhook.doofenshmirtz.me/status"
)
